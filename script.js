...
const allLinksData = [
    ...
    // Web
    { superCategory: 'web', icon: '<link rel="icon" href="https://www.moysklad.uz/favicon.svg" type="image/svg+xml">', title: 'MoySklad', description: 'Ombor uchun dastur', url: 'https://online.moysklad.ru/app/#homepage' },
